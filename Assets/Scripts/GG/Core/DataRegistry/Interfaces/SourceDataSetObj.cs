...
public abstract class SourceDataSetObj<L, C> : DataObjHeader, IDataSetObj<L, C> {
    public L m_data;
    public virtual ITraits<L, C> Traits { get; }
    public abstract new C this[int elem] { get; set; }
    public abstract new C this[string elem] { get; set; }
