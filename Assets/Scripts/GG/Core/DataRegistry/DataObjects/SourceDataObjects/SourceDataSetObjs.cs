...
public class TriggerListDataObj : SourceDataSetObj<List<Trigger>, Trigger> {
    ...
    public override ITraits<List<Trigger>> Traits { get=>m_traits; }
    ...
    public ComponentAccessType PreferredAccessType { get=>ComponentAccesType.Index; }
    public int NComponents { get=>Data.Count; }
    public bool ElementAccessByIndex() { return true; }
    public bool ElementAccessByString() { return false; }
    public string GetComponentName(int index) { return index.ToString(); }
    public int GetComponentIndex(string elem) { int index; if (int.TryParse(elem, index)){return index;} return -1; }
    public Trigger this[int elem] { get { return data[index]; } set { data[index]=value; } }
    public Trigger this[string elem] { get {
    #if DEBUG
    ...
    public override TriggerListDataObj Clone(IObjRegistry parent) {
        TriggerListDataObj obj = new TriggerListDataObj(m_name, parent, m_data);
        return IObj(obj);
    }
    TriggerListDataObj(string name, IObjRegistry parent = null, List<Trigger> m_data = default(m_data)) : base(name, parent, m_data) {}
...
public class BoolListDataObj : SourceDataSetObj<List<bool>, bool> {
    ...
    public override ITraits<List<bool>> Traits { get=>m_traits; }
    ...
    public string GetComponentName(int index) { return index.ToString(); }
    public int GetComponentIndex(string elem) { int index; if (int.TryParse(elem, index)){return index;} return -1; }
    public bool this[int elem] { get { return data[index]; } set { data[index]=value; } }
    public bool this[string elem] { get {
    #if DEBUG
    throw new System.InvalidOperationException();
    #else
    return null;
    ...
    public override BoolListDataObj Clone(IObjRegistry parent) {
        BoolListDataObj obj = new BoolListDataObj(m_name, parent, m_data);
        return IObj(obj);
    }
    BoolListDataObj(string name, IObjRegistry parent = null, List<bool> m_data = default(m_data)) : base(name, parent, m_data) {}
...
public class CharListDataObj : SourceDataSetObj<List<char>, char> {
    ...
    public override ITraits<List<char>> Traits { get=>m_traits; }
    ...
    public string GetComponentName(int index) { return index.ToString(); }
    public int GetComponentIndex(string elem) { int index; if (int.TryParse(elem, index)){return index;} return -1; }
    public char this[int elem] { get { return data[index]; } set { data[index]=value; } }
    public char this[string elem] { get {
    #if DEBUG
    throw new System.InvalidOperationException();
    #else
    return null;
    ...
    public override CharListDataObj Clone(IObjRegistry parent) {
        CharListDataObj obj = new CharListDataObj(m_name, parent, m_data);
        return IObj(obj);
    }
    CharListDataObj(string name, IObjRegistry parent = null, List<char> m_data = default(m_data)) : base(name, parent, m_data) {}
...
public class StringListDataObj : SourceDataSetObj<List<string>, string> {
    ...
    public override ITraits<List<string>> Traits { get=>m_traits; }
    ...
    public string GetComponentName(int index) { return index.ToString(); }
    public int GetComponentIndex(string elem) { int index; if (int.TryParse(elem, index)){return index;} return -1; }
    public string this[int elem] { get { return data[index]; } set { data[index]=value; } }
    public string this[string elem] { get {
    #if DEBUG
    throw new System.InvalidOperationException();
    #else
    return null;
    ...
    public override StringListDataObj Clone(IObjRegistry parent) {
        StringListDataObj obj = new StringListDataObj(m_name, parent, m_data);
        return IObj(obj);
    }
    StringListDataObj(string name, IObjRegistry parent = null, List<string> m_data = default(m_data)) : base(name, parent, m_data) {}
...
public class IntListDataObj : SourceDataSetObj<List<int>, int> {
    ...
    public override ITraits<List<int>> Traits { get=>m_traits; }
    ...
    public string GetComponentName(int index) { return index.ToString(); }
    public int GetComponentIndex(string elem) { int index; if (int.TryParse(elem, index)){return index;} return -1; }
    public int this[int elem] { get { return data[index]; } set { data[index]=value; } }
    public int this[string elem] { get {
    #if DEBUG
    throw new System.InvalidOperationException();
    #else
    return null;
    ...
    public override IntListDataObj Clone(IObjRegistry parent) {
        IntListDataObj obj = new IntListDataObj(m_name, parent, m_data);
        return IObj(obj);
    }
    IntListDataObj(string name, IObjRegistry parent = null, List<int> m_data = default(m_data)) : base(name, parent, m_data) {}
...
public class FloatListDataObj : SourceDataSetObj<List<float>, float> {
    ...
    public override ITraits<List<float>> Traits { get=>m_traits; }
    ...
    public string GetComponentName(int index) { return index.ToString(); }
    public int GetComponentIndex(string elem) { int index; if (int.TryParse(elem, index)){return index;} return -1; }
    public float this[int elem] { get { return data[index]; } set { data[index]=value; } }
    public float this[string elem] { get {
    #if DEBUG
    throw new System.InvalidOperationException();
    #else
    return null;
    ...
    public override FloatListDataObj Clone(IObjRegistry parent) {
        FloatListDataObj obj = new FloatListDataObj(m_name, parent, m_data);
        return IObj(obj);
    }
    FloatListDataObj(string name, IObjRegistry parent = null, List<float> m_data = default(m_data)) : base(name, parent, m_data) {}
...
public class Vector2IntListDataObj : SourceDataSetObj<List<Vector2Int>, Vector2Int> {
    ...
    public override ITraits<List<Vector2Int>> Traits { get=>m_traits; }
    ...
    public string GetComponentName(int index) { return index.ToString(); }
    public int GetComponentIndex(string elem) { int index; if (int.TryParse(elem, index)){return index;} return -1; }
    public Vector2Int this[int elem] { get { return data[index]; } set { data[index]=value; } }
    public Vector2Int this[string elem] { get {
    #if DEBUG
    throw new System.InvalidOperationException();
    #else
    return null;
    ...
    public override Vector2IntListDataObj Clone(IObjRegistry parent) {
        Vector2IntListDataObj obj = new Vector2IntListDataObj(m_name, parent, m_data);
        return IObj(obj);
    }
    Vector2IntListDataObj(string name, IObjRegistry parent = null, List<Vector2Int> m_data = default(m_data)) : base(name, parent, m_data) {}
...
public class Vector2ListDataObj : SourceDataSetObj<List<Vector2>, Vector2> {
    ...
    public override ITraits<List<Vector2>> Traits { get=>m_traits; }
    ...
    public string GetComponentName(int index) { return index.ToString(); }
    public int GetComponentIndex(string elem) { int index; if (int.TryParse(elem, index)){return index;} return -1; }
    public Vector2 this[int elem] { get { return data[index]; } set { data[index]=value; } }
    public Vector2 this[string elem] { get {
    #if DEBUG
    throw new System.InvalidOperationException();
    #else
    return null;
    ...
    public override Vector2ListDataObj Clone(IObjRegistry parent) {
        Vector2ListDataObj obj = new Vector2ListDataObj(m_name, parent, m_data);
        return IObj(obj);
    }
    Vector2ListDataObj(string name, IObjRegistry parent = null, List<Vector2> m_data = default(m_data)) : base(name, parent, m_data) {}
...
public class Vector3IntListDataObj : SourceDataSetObj<List<Vector3Int>, Vector3Int> {
    ...
    public override ITraits<List<Vector3Int>> Traits { get=>m_traits; }
    ...
    public string GetComponentName(int index) { return index.ToString(); }
    public int GetComponentIndex(string elem) { int index; if (int.TryParse(elem, index)){return index;} return -1; }
    public Vector3Int this[int elem] { get { return data[index]; } set { data[index]=value; } }
    public Vector3Int this[string elem] { get {
    #if DEBUG
    throw new System.InvalidOperationException();
    #else
    return null;
    ...
    public override Vector3IntListDataObj Clone(IObjRegistry parent) {
        Vector3IntListDataObj obj = new Vector3IntListDataObj(m_name, parent, m_data);
        return IObj(obj);
    }
    Vector3IntListDataObj(string name, IObjRegistry parent = null, List<Vector3Int> m_data = default(m_data)) : base(name, parent, m_data) {}
...
public class Vector3ListDataObj : SourceDataSetObj<List<Vector3>, Vector3> {
    ...
    public override ITraits<List<Vector3>> Traits { get=>m_traits; }
    ...
    public string GetComponentName(int index) { return index.ToString(); }
    public int GetComponentIndex(string elem) { int index; if (int.TryParse(elem, index)){return index;} return -1; }
    public Vector3 this[int elem] { get { return data[index]; } set { data[index]=value; } }
    public Vector3 this[string elem] { get {
    #if DEBUG
    throw new System.InvalidOperationException();
    #else
    return null;
    ...
    public override Vector3ListDataObj Clone(IObjRegistry parent) {
        Vector3ListDataObj obj = new Vector3ListDataObj(m_name, parent, m_data);
        return IObj(obj);
    }
    Vector3ListDataObj(string name, IObjRegistry parent = null, List<Vector3> m_data = default(m_data)) : base(name, parent, m_data) {}
...
public class Vector4ListDataObj : SourceDataSetObj<List<Vector4>, Vector4> {
    ...
    public override ITraits<List<Vector4>> Traits { get=>m_traits; }
    ...
    public string GetComponentName(int index) { return index.ToString(); }
    public int GetComponentIndex(string elem) { int index; if (int.TryParse(elem, index)){return index;} return -1; }
    public Vector4 this[int elem] { get { return data[index]; } set { data[index]=value; } }
    public Vector4 this[string elem] { get {
    #if DEBUG
    throw new System.InvalidOperationException();
    #else
    return null;
    ...
    public override Vector4ListDataObj Clone(IObjRegistry parent) {
        Vector4ListDataObj obj = new Vector4ListDataObj(m_name, parent, m_data);
        return IObj(obj);
    }
    Vector4ListDataObj(string name, IObjRegistry parent = null, List<Vector4> m_data = default(m_data)) : base(name, parent, m_data) {}
...
public class QuaternionListDataObj : SourceDataSetObj<List<Quaternion>, Quaternion> {
    ...
    public override ITraits<List<Quaternion>> Traits { get=>m_traits; }
    ...
    public string GetComponentName(int index) { return index.ToString(); }
    public int GetComponentIndex(string elem) { int index; if (int.TryParse(elem, index)){return index;} return -1; }
    public Quaternion this[int elem] { get { return data[index]; } set { data[index]=value; } }
    public Quaternion this[string elem] { get {
    #if DEBUG
    throw new System.InvalidOperationException();
    #else
    return null;
    ...
    public override QuaternionListDataObj Clone(IObjRegistry parent) {
        QuaternionListDataObj obj = new QuaternionListDataObj(m_name, parent, m_data);
        return IObj(obj);
    }
    QuaternionListDataObj(string name, IObjRegistry parent = null, List<Quaternion> m_data = default(m_data)) : base(name, parent, m_data) {}
...
public class KVariablesTriggerDataObj : SourceDataSetObj<KVariables<Trigger>, Trigger> {
    ...
    public override ITraitsSimple<Trigger> TraitsSimple { get=>m_traitsSimple; }
    public override ITraits<KVariables<Trigger>> Traits { get=>m_traits; }
    public override DataTypeEnum DataType { get=>DataTypeEnum.KVariables_Trigger; }
    public override DataTypeEnum ComponentType { get=>DataTypeEnum.TriggerType; }
    public ComponentAccessType PreferredAccessType { get=>ComponentAccesType.String; }
    public int NComponents { get=>5; }
    public bool ElementAccessByIndex() { return true; }
    public bool ElementAccessByString() { return true; }
    public string GetComponentName(int index) { return KVariableTypeInfo.IndexToKVariableEnum(index).ToString(); }
    public int GetComponentIndex(string elem) { return KVariableTypeInfo.KVariableEnumToIndex(KVariableTypeInfo.Aliases(index)); }
    public Trigger this[int elem] { get { Trigger value; data.Get(KVariableTypeInfo.IndexToKVariableEnum(index), out value);return value; } set { data.Set(KVariableTypeInfo.IndexToKVariableEnum(index), value); } }
    public Trigger this[string elem] { get { Trigger value; data.Get(elem, out value); return value; } set{ data.Set(elem,value); } }
    public override KVariablesTriggerDataObj Clone(IObjRegistry parent) {
        KVariablesTriggerDataObj obj = new KVariablesTriggerDataObj(m_name, parent, m_data);
        return IObj(obj);
    }
    KVariablesTriggerDataObj(string name, IObjRegistry parent = null, KVariables<Trigger> m_data = default(m_data)) : base(name, parent, m_data) {}
...
public class KVariablesBoolDataObj : SourceDataSetObj<KVariables<bool>, bool> {
    ...
    public override ITraitsSimple<bool> TraitsSimple { get=>m_traitsSimple; }
    public override ITraits<KVariables<bool>> Traits { get=>m_traits; }
    ...
    public string GetComponentName(int index) { return KVariableTypeInfo.IndexToKVariableEnum(index).ToString(); }
    public int GetComponentIndex(string elem) { return KVariableTypeInfo.KVariableEnumToIndex(KVariableTypeInfo.Aliases(index)); }
    public bool this[int elem] { get { bool value; data.Get(KVariableTypeInfo.IndexToKVariableEnum(index), out value);return value; } set { data.Set(KVariableTypeInfo.IndexToKVariableEnum(index), value); } }
    public bool this[string elem] { get { bool value; data.Get(elem, out value); return value; } set{ data.Set(elem,value); } }
    public override KVariablesBoolDataObj Clone(IObjRegistry parent) {
        KVariablesBoolDataObj obj = new KVariablesBoolDataObj(m_name, parent, m_data);
        return IObj(obj);
    }
    KVariablesBoolDataObj(string name, IObjRegistry parent = null, KVariables<bool> m_data = default(m_data)) : base(name, parent, m_data) {}
...
public class KVariablesCharDataObj : SourceDataSetObj<KVariables<char>, char> {
    ...
    public override ITraitsSimple<char> TraitsSimple { get=>m_traitsSimple; }
    public override ITraits<KVariables<char>> Traits { get=>m_traits; }
    ...
    public string GetComponentName(int index) { return KVariableTypeInfo.IndexToKVariableEnum(index).ToString(); }
    public int GetComponentIndex(string elem) { return KVariableTypeInfo.KVariableEnumToIndex(KVariableTypeInfo.Aliases(index)); }
    public char this[int elem] { get { char value; data.Get(KVariableTypeInfo.IndexToKVariableEnum(index), out value);return value; } set { data.Set(KVariableTypeInfo.IndexToKVariableEnum(index), value); } }
    public char this[string elem] { get { char value; data.Get(elem, out value); return value; } set{ data.Set(elem,value); } }
    public override KVariablesCharDataObj Clone(IObjRegistry parent) {
        KVariablesCharDataObj obj = new KVariablesCharDataObj(m_name, parent, m_data);
        return IObj(obj);
    }
    KVariablesCharDataObj(string name, IObjRegistry parent = null, KVariables<char> m_data = default(m_data)) : base(name, parent, m_data) {}
...
public class KVariablesStringDataObj : SourceDataSetObj<KVariables<string>, string> {
    ...
    public override ITraitsSimple<string> TraitsSimple { get=>m_traitsSimple; }
    public override ITraits<KVariables<string>> Traits { get=>m_traits; }
    ...
    public string GetComponentName(int index) { return KVariableTypeInfo.IndexToKVariableEnum(index).ToString(); }
    public int GetComponentIndex(string elem) { return KVariableTypeInfo.KVariableEnumToIndex(KVariableTypeInfo.Aliases(index)); }
    public string this[int elem] { get { string value; data.Get(KVariableTypeInfo.IndexToKVariableEnum(index), out value);return value; } set { data.Set(KVariableTypeInfo.IndexToKVariableEnum(index), value); } }
    public string this[string elem] { get { string value; data.Get(elem, out value); return value; } set{ data.Set(elem,value); } }
    public override KVariablesStringDataObj Clone(IObjRegistry parent) {
        KVariablesStringDataObj obj = new KVariablesStringDataObj(m_name, parent, m_data);
        return IObj(obj);
    }
    KVariablesStringDataObj(string name, IObjRegistry parent = null, KVariables<string> m_data = default(m_data)) : base(name, parent, m_data) {}
...
public class KVariablesIntDataObj : SourceDataSetObj<KVariables<int>, int> {
    ...
    public override ITraitsSimple<int> TraitsSimple { get=>m_traitsSimple; }
    public override ITraits<KVariables<int>> Traits { get=>m_traits; }
    ...
    public string GetComponentName(int index) { return KVariableTypeInfo.IndexToKVariableEnum(index).ToString(); }
    public int GetComponentIndex(string elem) { return KVariableTypeInfo.KVariableEnumToIndex(KVariableTypeInfo.Aliases(index)); }
    public int this[int elem] { get { int value; data.Get(KVariableTypeInfo.IndexToKVariableEnum(index), out value);return value; } set { data.Set(KVariableTypeInfo.IndexToKVariableEnum(index), value); } }
    public int this[string elem] { get { int value; data.Get(elem, out value); return value; } set{ data.Set(elem,value); } }
    public override KVariablesIntDataObj Clone(IObjRegistry parent) {
        KVariablesIntDataObj obj = new KVariablesIntDataObj(m_name, parent, m_data);
        return IObj(obj);
    }
    KVariablesIntDataObj(string name, IObjRegistry parent = null, KVariables<int> m_data = default(m_data)) : base(name, parent, m_data) {}
...
public class KVariablesFloatDataObj : SourceDataSetObj<KVariables<float>, float> {
    ...
    public override ITraitsSimple<float> TraitsSimple { get=>m_traitsSimple; }
    public override ITraits<KVariables<float>> Traits { get=>m_traits; }
    ...
    public string GetComponentName(int index) { return KVariableTypeInfo.IndexToKVariableEnum(index).ToString(); }
    public int GetComponentIndex(string elem) { return KVariableTypeInfo.KVariableEnumToIndex(KVariableTypeInfo.Aliases(index)); }
    public float this[int elem] { get { float value; data.Get(KVariableTypeInfo.IndexToKVariableEnum(index), out value);return value; } set { data.Set(KVariableTypeInfo.IndexToKVariableEnum(index), value); } }
    public float this[string elem] { get { float value; data.Get(elem, out value); return value; } set{ data.Set(elem,value); } }
    public override KVariablesFloatDataObj Clone(IObjRegistry parent) {
        KVariablesFloatDataObj obj = new KVariablesFloatDataObj(m_name, parent, m_data);
        return IObj(obj);
    }
    KVariablesFloatDataObj(string name, IObjRegistry parent = null, KVariables<float> m_data = default(m_data)) : base(name, parent, m_data) {}
...
public class KVariablesVector2IntDataObj : SourceDataSetObj<KVariables<Vector2Int>, Vector2Int> {
    ...
    public override ITraitsSimple<Vector2Int> TraitsSimple { get=>m_traitsSimple; }
    public override ITraits<KVariables<Vector2Int>> Traits { get=>m_traits; }
    ...
    public string GetComponentName(int index) { return KVariableTypeInfo.IndexToKVariableEnum(index).ToString(); }
    public int GetComponentIndex(string elem) { return KVariableTypeInfo.KVariableEnumToIndex(KVariableTypeInfo.Aliases(index)); }
    public Vector2Int this[int elem] { get { Vector2Int value; data.Get(KVariableTypeInfo.IndexToKVariableEnum(index), out value);return value; } set { data.Set(KVariableTypeInfo.IndexToKVariableEnum(index), value); } }
    public Vector2Int this[string elem] { get { Vector2Int value; data.Get(elem, out value); return value; } set{ data.Set(elem,value); } }
    public override KVariablesVector2IntDataObj Clone(IObjRegistry parent) {
        KVariablesVector2IntDataObj obj = new KVariablesVector2IntDataObj(m_name, parent, m_data);
        return IObj(obj);
    }
    KVariablesVector2IntDataObj(string name, IObjRegistry parent = null, KVariables<Vector2Int> m_data = default(m_data)) : base(name, parent, m_data) {}
...
public class KVariablesVector2DataObj : SourceDataSetObj<KVariables<Vector2>, Vector2> {
    ...
    public override ITraitsSimple<Vector2> TraitsSimple { get=>m_traitsSimple; }
    public override ITraits<KVariables<Vector2>> Traits { get=>m_traits; }
    ...
    public string GetComponentName(int index) { return KVariableTypeInfo.IndexToKVariableEnum(index).ToString(); }
    public int GetComponentIndex(string elem) { return KVariableTypeInfo.KVariableEnumToIndex(KVariableTypeInfo.Aliases(index)); }
    public Vector2 this[int elem] { get { Vector2 value; data.Get(KVariableTypeInfo.IndexToKVariableEnum(index), out value);return value; } set { data.Set(KVariableTypeInfo.IndexToKVariableEnum(index), value); } }
    public Vector2 this[string elem] { get { Vector2 value; data.Get(elem, out value); return value; } set{ data.Set(elem,value); } }
    public override KVariablesVector2DataObj Clone(IObjRegistry parent) {
        KVariablesVector2DataObj obj = new KVariablesVector2DataObj(m_name, parent, m_data);
        return IObj(obj);
    }
    KVariablesVector2DataObj(string name, IObjRegistry parent = null, KVariables<Vector2> m_data = default(m_data)) : base(name, parent, m_data) {}
...
public class KVariablesVector3IntDataObj : SourceDataSetObj<KVariables<Vector3Int>, Vector3Int> {
    ...
    public override ITraitsSimple<Vector3Int> TraitsSimple { get=>m_traitsSimple; }
    public override ITraits<KVariables<Vector3Int>> Traits { get=>m_traits; }
    ...
    public string GetComponentName(int index) { return KVariableTypeInfo.IndexToKVariableEnum(index).ToString(); }
    public int GetComponentIndex(string elem) { return KVariableTypeInfo.KVariableEnumToIndex(KVariableTypeInfo.Aliases(index)); }
    public Vector3Int this[int elem] { get { Vector3Int value; data.Get(KVariableTypeInfo.IndexToKVariableEnum(index), out value);return value; } set { data.Set(KVariableTypeInfo.IndexToKVariableEnum(index), value); } }
    public Vector3Int this[string elem] { get { Vector3Int value; data.Get(elem, out value); return value; } set{ data.Set(elem,value); } }
    public override KVariablesVector3IntDataObj Clone(IObjRegistry parent) {
        KVariablesVector3IntDataObj obj = new KVariablesVector3IntDataObj(m_name, parent, m_data);
        return IObj(obj);
    }
    KVariablesVector3IntDataObj(string name, IObjRegistry parent = null, KVariables<Vector3Int> m_data = default(m_data)) : base(name, parent, m_data) {}
...
public class KVariablesVector3DataObj : SourceDataSetObj<KVariables<Vector3>, Vector3> {
    ...
    public override ITraitsSimple<Vector3> TraitsSimple { get=>m_traitsSimple; }
    public override ITraits<KVariables<Vector3>> Traits { get=>m_traits; }
    ...
    public string GetComponentName(int index) { return KVariableTypeInfo.IndexToKVariableEnum(index).ToString(); }
    public int GetComponentIndex(string elem) { return KVariableTypeInfo.KVariableEnumToIndex(KVariableTypeInfo.Aliases(index)); }
    public Vector3 this[int elem] { get { Vector3 value; data.Get(KVariableTypeInfo.IndexToKVariableEnum(index), out value);return value; } set { data.Set(KVariableTypeInfo.IndexToKVariableEnum(index), value); } }
    public Vector3 this[string elem] { get { Vector3 value; data.Get(elem, out value); return value; } set{ data.Set(elem,value); } }
    public override KVariablesVector3DataObj Clone(IObjRegistry parent) {
        KVariablesVector3DataObj obj = new KVariablesVector3DataObj(m_name, parent, m_data);
        return IObj(obj);
    }
    KVariablesVector3DataObj(string name, IObjRegistry parent = null, KVariables<Vector3> m_data = default(m_data)) : base(name, parent, m_data) {}
...
public class KVariablesVector4DataObj : SourceDataSetObj<KVariables<Vector4>, Vector4> {
    ...
    public override ITraitsSimple<Vector4> TraitsSimple { get=>m_traitsSimple; }
    public override ITraits<KVariables<Vector4>> Traits { get=>m_traits; }
    ...
    public string GetComponentName(int index) { return KVariableTypeInfo.IndexToKVariableEnum(index).ToString(); }
    public int GetComponentIndex(string elem) { return KVariableTypeInfo.KVariableEnumToIndex(KVariableTypeInfo.Aliases(index)); }
    public Vector4 this[int elem] { get { Vector4 value; data.Get(KVariableTypeInfo.IndexToKVariableEnum(index), out value);return value; } set { data.Set(KVariableTypeInfo.IndexToKVariableEnum(index), value); } }
    public Vector4 this[string elem] { get { Vector4 value; data.Get(elem, out value); return value; } set{ data.Set(elem,value); } }
    public override KVariablesVector4DataObj Clone(IObjRegistry parent) {
        KVariablesVector4DataObj obj = new KVariablesVector4DataObj(m_name, parent, m_data);
        return IObj(obj);
    }
    KVariablesVector4DataObj(string name, IObjRegistry parent = null, KVariables<Vector4> m_data = default(m_data)) : base(name, parent, m_data) {}
...
public class KVariablesQuaternionDataObj : SourceDataSetObj<KVariables<Quaternion>, Quaternion> {
    ...
    public override ITraitsSimple<Quaternion> TraitsSimple { get=>m_traitsSimple; }
    public override ITraits<KVariables<Quaternion>> Traits { get=>m_traits; }
    ...
    public string GetComponentName(int index) { return KVariableTypeInfo.IndexToKVariableEnum(index).ToString(); }
    public int GetComponentIndex(string elem) { return KVariableTypeInfo.KVariableEnumToIndex(KVariableTypeInfo.Aliases(index)); }
    public Quaternion this[int elem] { get { Quaternion value; data.Get(KVariableTypeInfo.IndexToKVariableEnum(index), out value);return value; } set { data.Set(KVariableTypeInfo.IndexToKVariableEnum(index), value); } }
    public Quaternion this[string elem] { get { Quaternion value; data.Get(elem, out value); return value; } set{ data.Set(elem,value); } }
    public override KVariablesQuaternionDataObj Clone(IObjRegistry parent) {
        KVariablesQuaternionDataObj obj = new KVariablesQuaternionDataObj(m_name, parent, m_data);
        return IObj(obj);
    }
    KVariablesQuaternionDataObj(string name, IObjRegistry parent = null, KVariables<Quaternion> m_data = default(m_data)) : base(name, parent, m_data) {}
...
public class KVariablesExtTriggerDataObj : SourceDataSetObj<KVariablesExt<Trigger>, Trigger> {
    ...
    public override ITraitsSimple<Trigger> TraitsSimple { get=>m_traitsSimple; }
    public override ITraits<KVariablesExt<Trigger>> Traits { get=>m_traits; }
    public override DataTypeEnum DataType { get=>DataTypeEnum.KVariablesExt_Trigger; }
    public override DataTypeEnum ComponentType { get=>DataTypeEnum.TriggerType; }
    public ComponentAccessType PreferredAccessType { get=>ComponentAccesType.String; }
    public int NComponents { get=>8; }
    public bool ElementAccessByIndex() { return true; }
    public bool ElementAccessByString() { return true; }
    public string GetComponentName(int index) { return KVariableTypeInfo.IndexToKVariableEnum(index).ToString(); }
    public int GetComponentIndex(string elem) { return KVariableTypeInfo.KVariableEnumToIndex(KVariableTypeInfo.Aliases(index)); }
    public Trigger this[int elem] { get { Trigger value; data.Get(KVariableTypeInfo.IndexToKVariableEnum(index), out value);return value; } set { data.Set(KVariableTypeInfo.IndexToKVariableEnum(index), value); } }
    public Trigger this[string elem] { get { Trigger value; data.Get(elem, out value); return value; } set{ data.Set(elem,value); } }
    public override KVariablesExtTriggerDataObj Clone(IObjRegistry parent) {
        KVariablesExtTriggerDataObj obj = new KVariablesExtTriggerDataObj(m_name, parent, m_data);
        return IObj(obj);
    }
    KVariablesExtTriggerDataObj(string name, IObjRegistry parent = null, KVariablesExt<Trigger> m_data = default(m_data)) : base(name, parent, m_data) {}
...
public class KVariablesExtBoolDataObj : SourceDataSetObj<KVariablesExt<bool>, bool> {
    ...
    public override ITraitsSimple<bool> TraitsSimple { get=>m_traitsSimple; }
    public override ITraits<KVariablesExt<bool>> Traits { get=>m_traits; }
    ...
    public bool this[int elem] { get { bool value; data.Get(KVariableTypeInfo.IndexToKVariableEnum(index), out value);return value; } set { data.Set(KVariableTypeInfo.IndexToKVariableEnum(index), value); } }
    public bool this[string elem] { get { bool value; data.Get(elem, out value); return value; } set{ data.Set(elem,value); } }
    public override KVariablesExtBoolDataObj Clone(IObjRegistry parent) {
        KVariablesExtBoolDataObj obj = new KVariablesExtBoolDataObj(m_name, parent, m_data);
        return IObj(obj);
    }
    KVariablesExtBoolDataObj(string name, IObjRegistry parent = null, KVariablesExt<bool> m_data = default(m_data)) : base(name, parent, m_data) {}
...
public class KVariablesExtCharDataObj : SourceDataSetObj<KVariablesExt<char>, char> {
    ...
    public override ITraitsSimple<char> TraitsSimple { get=>m_traitsSimple; }
    public override ITraits<KVariablesExt<char>> Traits { get=>m_traits; }
    ...
    public char this[int elem] { get { char value; data.Get(KVariableTypeInfo.IndexToKVariableEnum(index), out value);return value; } set { data.Set(KVariableTypeInfo.IndexToKVariableEnum(index), value); } }
    public char this[string elem] { get { char value; data.Get(elem, out value); return value; } set{ data.Set(elem,value); } }
    public override KVariablesExtCharDataObj Clone(IObjRegistry parent) {
        KVariablesExtCharDataObj obj = new KVariablesExtCharDataObj(m_name, parent, m_data);
        return IObj(obj);
    }
    KVariablesExtCharDataObj(string name, IObjRegistry parent = null, KVariablesExt<char> m_data = default(m_data)) : base(name, parent, m_data) {}
...
public class KVariablesExtStringDataObj : SourceDataSetObj<KVariablesExt<string>, string> {
    ...
    public override ITraitsSimple<string> TraitsSimple { get=>m_traitsSimple; }
    public override ITraits<KVariablesExt<string>> Traits { get=>m_traits; }
    ...
    public string this[int elem] { get { string value; data.Get(KVariableTypeInfo.IndexToKVariableEnum(index), out value);return value; } set { data.Set(KVariableTypeInfo.IndexToKVariableEnum(index), value); } }
    public string this[string elem] { get { string value; data.Get(elem, out value); return value; } set{ data.Set(elem,value); } }
    public override KVariablesExtStringDataObj Clone(IObjRegistry parent) {
        KVariablesExtStringDataObj obj = new KVariablesExtStringDataObj(m_name, parent, m_data);
        return IObj(obj);
    }
    KVariablesExtStringDataObj(string name, IObjRegistry parent = null, KVariablesExt<string> m_data = default(m_data)) : base(name, parent, m_data) {}
...
public class KVariablesExtIntDataObj : SourceDataSetObj<KVariablesExt<int>, int> {
    ...
    public override ITraitsSimple<int> TraitsSimple { get=>m_traitsSimple; }
    public override ITraits<KVariablesExt<int>> Traits { get=>m_traits; }
    ...
    public int this[int elem] { get { int value; data.Get(KVariableTypeInfo.IndexToKVariableEnum(index), out value);return value; } set { data.Set(KVariableTypeInfo.IndexToKVariableEnum(index), value); } }
    public int this[string elem] { get { int value; data.Get(elem, out value); return value; } set{ data.Set(elem,value); } }
    public override KVariablesExtIntDataObj Clone(IObjRegistry parent) {
        KVariablesExtIntDataObj obj = new KVariablesExtIntDataObj(m_name, parent, m_data);
        return IObj(obj);
    }
    KVariablesExtIntDataObj(string name, IObjRegistry parent = null, KVariablesExt<int> m_data = default(m_data)) : base(name, parent, m_data) {}
...
public class KVariablesExtFloatDataObj : SourceDataSetObj<KVariablesExt<float>, float> {
    ...
    public override ITraitsSimple<float> TraitsSimple { get=>m_traitsSimple; }
    public override ITraits<KVariablesExt<float>> Traits { get=>m_traits; }
    ...
    public float this[int elem] { get { float value; data.Get(KVariableTypeInfo.IndexToKVariableEnum(index), out value);return value; } set { data.Set(KVariableTypeInfo.IndexToKVariableEnum(index), value); } }
    public float this[string elem] { get { float value; data.Get(elem, out value); return value; } set{ data.Set(elem,value); } }
    public override KVariablesExtFloatDataObj Clone(IObjRegistry parent) {
        KVariablesExtFloatDataObj obj = new KVariablesExtFloatDataObj(m_name, parent, m_data);
        return IObj(obj);
    }
    KVariablesExtFloatDataObj(string name, IObjRegistry parent = null, KVariablesExt<float> m_data = default(m_data)) : base(name, parent, m_data) {}
...
public class KVariablesExtVector2IntDataObj : SourceDataSetObj<KVariablesExt<Vector2Int>, Vector2Int> {
    ...
    public override ITraitsSimple<Vector2Int> TraitsSimple { get=>m_traitsSimple; }
    public override ITraits<KVariablesExt<Vector2Int>> Traits { get=>m_traits; }
    ...
    public Vector2Int this[int elem] { get { Vector2Int value; data.Get(KVariableTypeInfo.IndexToKVariableEnum(index), out value);return value; } set { data.Set(KVariableTypeInfo.IndexToKVariableEnum(index), value); } }
    public Vector2Int this[string elem] { get { Vector2Int value; data.Get(elem, out value); return value; } set{ data.Set(elem,value); } }
    public override KVariablesExtVector2IntDataObj Clone(IObjRegistry parent) {
        KVariablesExtVector2IntDataObj obj = new KVariablesExtVector2IntDataObj(m_name, parent, m_data);
        return IObj(obj);
    }
    KVariablesExtVector2IntDataObj(string name, IObjRegistry parent = null, KVariablesExt<Vector2Int> m_data = default(m_data)) : base(name, parent, m_data) {}
...
public class KVariablesExtVector2DataObj : SourceDataSetObj<KVariablesExt<Vector2>, Vector2> {
    ...
    public override ITraitsSimple<Vector2> TraitsSimple { get=>m_traitsSimple; }
    public override ITraits<KVariablesExt<Vector2>> Traits { get=>m_traits; }
    ...
    public Vector2 this[int elem] { get { Vector2 value; data.Get(KVariableTypeInfo.IndexToKVariableEnum(index), out value);return value; } set { data.Set(KVariableTypeInfo.IndexToKVariableEnum(index), value); } }
    public Vector2 this[string elem] { get { Vector2 value; data.Get(elem, out value); return value; } set{ data.Set(elem,value); } }
    public override KVariablesExtVector2DataObj Clone(IObjRegistry parent) {
        KVariablesExtVector2DataObj obj = new KVariablesExtVector2DataObj(m_name, parent, m_data);
        return IObj(obj);
    }
    KVariablesExtVector2DataObj(string name, IObjRegistry parent = null, KVariablesExt<Vector2> m_data = default(m_data)) : base(name, parent, m_data) {}
...
public class KVariablesExtVector3IntDataObj : SourceDataSetObj<KVariablesExt<Vector3Int>, Vector3Int> {
    ...
    public override ITraitsSimple<Vector3Int> TraitsSimple { get=>m_traitsSimple; }
    public override ITraits<KVariablesExt<Vector3Int>> Traits { get=>m_traits; }
    ...
    public Vector3Int this[int elem] { get { Vector3Int value; data.Get(KVariableTypeInfo.IndexToKVariableEnum(index), out value);return value; } set { data.Set(KVariableTypeInfo.IndexToKVariableEnum(index), value); } }
    public Vector3Int this[string elem] { get { Vector3Int value; data.Get(elem, out value); return value; } set{ data.Set(elem,value); } }
    public override KVariablesExtVector3IntDataObj Clone(IObjRegistry parent) {
        KVariablesExtVector3IntDataObj obj = new KVariablesExtVector3IntDataObj(m_name, parent, m_data);
        return IObj(obj);
    }
    KVariablesExtVector3IntDataObj(string name, IObjRegistry parent = null, KVariablesExt<Vector3Int> m_data = default(m_data)) : base(name, parent, m_data) {}
...
public class KVariablesExtVector3DataObj : SourceDataSetObj<KVariablesExt<Vector3>, Vector3> {
    ...
    public override ITraitsSimple<Vector3> TraitsSimple { get=>m_traitsSimple; }
    public override ITraits<KVariablesExt<Vector3>> Traits { get=>m_traits; }
    ...
    public Vector3 this[int elem] { get { Vector3 value; data.Get(KVariableTypeInfo.IndexToKVariableEnum(index), out value);return value; } set { data.Set(KVariableTypeInfo.IndexToKVariableEnum(index), value); } }
    public Vector3 this[string elem] { get { Vector3 value; data.Get(elem, out value); return value; } set{ data.Set(elem,value); } }
    public override KVariablesExtVector3DataObj Clone(IObjRegistry parent) {
        KVariablesExtVector3DataObj obj = new KVariablesExtVector3DataObj(m_name, parent, m_data);
        return IObj(obj);
    }
    KVariablesExtVector3DataObj(string name, IObjRegistry parent = null, KVariablesExt<Vector3> m_data = default(m_data)) : base(name, parent, m_data) {}
...
public class KVariablesExtVector4DataObj : SourceDataSetObj<KVariablesExt<Vector4>, Vector4> {
    ...
    public override ITraitsSimple<Vector4> TraitsSimple { get=>m_traitsSimple; }
    public override ITraits<KVariablesExt<Vector4>> Traits { get=>m_traits; }
    ...
    public Vector4 this[int elem] { get { Vector4 value; data.Get(KVariableTypeInfo.IndexToKVariableEnum(index), out value);return value; } set { data.Set(KVariableTypeInfo.IndexToKVariableEnum(index), value); } }
    public Vector4 this[string elem] { get { Vector4 value; data.Get(elem, out value); return value; } set{ data.Set(elem,value); } }
    public override KVariablesExtVector4DataObj Clone(IObjRegistry parent) {
        KVariablesExtVector4DataObj obj = new KVariablesExtVector4DataObj(m_name, parent, m_data);
        return IObj(obj);
    }
    KVariablesExtVector4DataObj(string name, IObjRegistry parent = null, KVariablesExt<Vector4> m_data = default(m_data)) : base(name, parent, m_data) {}
...
public class KVariablesExtQuaternionDataObj : SourceDataSetObj<KVariablesExt<Quaternion>, Quaternion> {
    ...
    public override ITraitsSimple<Quaternion> TraitsSimple { get=>m_traitsSimple; }
    public override ITraits<KVariablesExt<Quaternion>> Traits { get=>m_traits; }
    ...
    public Quaternion this[int elem] { get { Quaternion value; data.Get(KVariableTypeInfo.IndexToKVariableEnum(index), out value);return value; } set { data.Set(KVariableTypeInfo.IndexToKVariableEnum(index), value); } }
    public Quaternion this[string elem] { get { Quaternion value; data.Get(elem, out value); return value; } set{ data.Set(elem,value); } }
    public override KVariablesExtQuaternionDataObj Clone(IObjRegistry parent) {
        KVariablesExtQuaternionDataObj obj = new KVariablesExtQuaternionDataObj(m_name, parent, m_data);
        return IObj(obj);
    }
    KVariablesExtQuaternionDataObj(string name, IObjRegistry parent = null, KVariablesExt<Quaternion> m_data = default(m_data)) : base(name, parent, m_data) {}
