...
/// </summary>
public class DataObjectHeader : IObject {
    ...
    public virtual IObject CloneHeader() {
    ...
    public DataObjectHeader(string name, IObjectRegistry parent = null) {
        m_name = name;
    ...
    public DataObjectHeader(IObject ido) {
        m_name = ido.Name;
        m_id = ido.Id;
        m_mtag = ido.MTag;
        m_parent = ido.Parent;
